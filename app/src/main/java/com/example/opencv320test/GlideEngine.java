...
public class GlideEngine implements ImageEngine {
    ...
    private static com.example.opencv320test.GlideEngine instance;

    public static ImageEngine createGlideEngine() {
        if (null == instance) {
            synchronized (com.example.opencv320test.GlideEngine.class) {
                if (null == instance) {
                    instance = new com.example.opencv320test.GlideEngine();
                }
            }
        }
        return instance;
